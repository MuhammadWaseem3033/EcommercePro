...
@section('content')
    ...
    <div class="borderclass">
        <a class="btn btn-relief-outline-primary" style="margin:5px;margin-left:85%;" data-bs-toggle="tooltip"
            href="{{ route('admin.product.create.product') }}"><i class="" style="font-size: 1.1rem"
                class="m-10">Add Product</i>
        </a>
            ...
            <tbody>
                ...
                @foreach ($products as $product)
                    <tr>
                        ...
                        <th> <a href="{{ url('delete-product', $product->id) }}"
                                class="btn btn-relief-outline-warning me-1 "
                                onclick="return confirm('Are you sure Delete This Category')">Delete</a>
                            <a href="{{ url('update-product', $product->id) }}"
                                class="btn btn-relief-outline-info me-1 ">Edit</a>
                        </th>
                    </tr>
                @endforeach
            </tbody>
