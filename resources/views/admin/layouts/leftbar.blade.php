...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ request()->routeIs('admin.category') ? 'active' : null }}">
            ...
            {{-- <li class="nav-item {{ request()->routeIs('admin.create.category') ? 'active' : null }}">
                <a class="d-flex align-items-center" href="{{route('admin.create.category')}}">
                    <i data-feather='codepen'></i>
                    <span class="menu-title text-truncate" data-i18n="Email">Create Category</span>
                </a>
            </li>            --}}
            <li class="nav-item {{ request()->routeIs('product') ? 'active' : null }}">
